...
SET(ATLAS_POSSIBLE_INCLUDE_PATHS
  ...
  /opt/local/include/atlas # OS X MacPorts path
  $ENV{ATLAS_DIR}
...
SET(ATLAS_POSSIBLE_LIBRARY_PATHS
  ...
  /usr/lib
  /usr/local/lib
  /opt/local/lib # OS X MacPorts path
  $ENV{ATLAS_DIR}
  $ENV{ATLAS_DIR}/lib
)
...
FIND_LIBRARY(ATLAS_ATLAS_LIBRARY NAMES atlas_r atlas satlas PATHS ${ATLAS_POSSIBLE_LIBRARY_PATHS})
